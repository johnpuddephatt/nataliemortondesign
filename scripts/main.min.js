...
infiniteRequest.onload = function() {
  if (infiniteRequest.status >= 200 && infiniteRequest.status < 400) {
      ...
      console.log(infiniteRequest.response);
      var pinpen = [];
